...
inventory = [
	{ford: [{model: "Fiesta", year: 2010, license: "ASD123"},
			{model: "Mustang", year: 1965, license: "QWE456"}
		] },
	{seat: [{model: "León", year: 2002, license: "ZXC567"},
			{model: "León", year: 2002, license: "YUI789"}
